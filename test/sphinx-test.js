...
describe('Sphinx', () => {
  ...
  it('should start wit.skiph no riddles', () => {
    const sphinx = new Sphinx();
  ...
  it('should collect only three riddles', () => {
    ...
    const riddle3 = {
      riddle: 'What starts wit.skiph an \'e\' and ends wit.skiph an \'e\' and contains one letter?',
      answer: 'An envelope'
    };
    const riddle4 = {
  ...
  it.skip('should scream wit.skiph rage if a hero gets all riddles correct', () => {
    const sphinx = new Sphinx();
    const riddle1 = {
      riddle: 'What word becomes shorter when you add two letters to it.skip?', 
      answer: 'short'
    ...
    sphinx.collectRiddle(riddle2);
    sphinx.attemptAnswer('short');
    const rage = sphinx.attemptAnswer('Halfway, after that it.skip\'s running out.');

    assert.equal(rage, 'PSSSSSSS THIS HAS NEVER HAPPENED, HOW DID YOU KNOW THE ANSWER WAS \"Halfway, after that it.skip\'s running out.\"???');
  });
  ...
  it.skip('should scream specifically about the last riddle to be answered', () => {
    ...
    sphinx.collectRiddle(riddle1);
    sphinx.collectRiddle(riddle2);
    sphinx.attemptAnswer('Halfway, after that it.skip\'s running out.');
